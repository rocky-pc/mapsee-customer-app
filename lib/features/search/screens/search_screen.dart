      ...
      child: Scaffold(
        ...
        body: SafeArea(child: GetBuilder<search.SearchController>(builder: (searchController) {
          return Column(children: [
            ...
            // --- START SWIGGY STYLE HEADER/SEARCH BAR ---
            Container(
              height: isDesktop ? 70 : 60, // Cleaner height
                    ...
                    child: Row(
                      children: [
                        ...
                        !isDesktop
                          ...
                          icon: const Icon(Icons.arrow_back, color: Colors.black54), // Simpler back arrow
                        )
                            : const SizedBox(width: Dimensions.paddingSizeSmall),

                        // 2. Search Field (The main visual element)
                        Expanded(
                          child: Container(
                            height: 45,
                            decoration: BoxDecoration(
                              color: Theme.of(context).colorScheme.surface, // Light grey/surface color
                            ...
                            child: Row(
                              children: [
                                ...
                                IconButton(
                                  ...
                                  icon: Icon(Icons.mic_none, size: 22, color: Theme.of(context).disabledColor), // Simpler mic icon
                                ),
                              ],
                            ),
                          ),
                        ...
                        // 3. Filter Button (Permanent Swiggy Style)
                        InkWell(
                          key: _searchBarKey, // Retaining this key for the filter dialog positioning
                          onTap: () {
                            // The filter button is primarily used to open the filter dialog when viewing search results.
                            if (!searchController.isSearchMode) {
                              // This will execute the 'else' block in _actionSearch, opening the filter.
                              _actionSearch(context, searchController, false);
                            } else {
                              // If in initial search mode, perform a search action
                          ...
                          child: Container(
                            ...
                            child: Icon(
                              Icons.filter_list,
                              size: 24,
                              color: Theme.of(context).primaryColor, // Use primary color for filter icon
                            ),
                          ),
                        ),
                      ],
            ...
            // --- END SWIGGY STYLE HEADER/SEARCH BAR ---
  ...
  Future<void> _showSearchDialog(double? maxValue, double? minValue, bool isRestaurant) async {
    ...
    await showDialog(
      ...
      builder: (context) => Stack(children: [
        Positioned(
          // The dialog is positioned based on the external filter button's location
