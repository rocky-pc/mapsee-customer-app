        ...
        return Container(
          ...
          child: (couponController.discount! <= 0 && !couponController.freeDelivery) ? Row(children: [
            ...
            InkWell(
              ...
              child: Container( // Container added for decoration
                height: 35, // Explicit height for button
                width: 70,  // Explicit width for button
                ...
                child: Padding(
                  padding: EdgeInsets.zero, // Padding is now zero as height/width are fixed

                  child: Row(
                      mainAxisAlignment: MainAxisAlignment.center, // Center the content inside the fixed size
                      children: [
                        Text(
                            'Apply'.tr,
                            style: robotoMedium.copyWith(
                              // Set color to cardColor for contrast against primaryColor background
                                color: Theme.of(context).cardColor,
