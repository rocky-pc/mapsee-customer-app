...
class AddressModel {
  ...
  AddressModel.fromJson(Map<String, dynamic> json) {
    ...
    }    if(json['zone_update_at'] != null) {
      zoneUpdateAt = Map<String, int>.from(json['zone_update_at']);
    }  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if(zoneUpdateAt != null) {
      data['zone_update_at'] = zoneUpdateAt;
    }
    return data;
  }
}