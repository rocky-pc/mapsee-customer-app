...
class ItemCardWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      height: ResponsiveHelper.isDesktop(context) ? 310 : 285,
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            ...
            spreadRadius: 1,// Shadow at the bottom for lift
          ),
        ],
      ),
        ...
        child: Column(children: [
          Expanded(
            ...
            child: Stack(
              ...
              children: [
                Padding(
                  padding: isCampaignItem ? const EdgeInsets.all(0) : const EdgeInsets.only(top: Dimensions.paddingSizeExtraSmall, left: Dimensions.paddingSizeExtraSmall, right: Dimensions.paddingSizeExtraSmall, bottom: Dimensions.paddingSizeExtraSmall),
                  child: ClipRRect(
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        shrinkWrap: true,
        itemCount: (isPopularNearbyItem == true && ResponsiveHelper.isMobile(context)) ? 1 : 6,
        itemBuilder: (context, index) {
          return Container(
            width: ResponsiveHelper.isDesktop(context) ? 220 : 190,
            ...
            child: Stack(
              children: [
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Shimmer(
                                  child: Row(
                                    children: [
                                      Container(width: 40, height: 12, decoration: BoxDecoration(color: Colors.grey[300], borderRadius: BorderRadius.circular(Dimensions.radiusSmall))),
                                      const SizedBox(width: 8),
                                      Container(width: 20, height: 20, decoration: BoxDecoration(shape: BoxShape.circle, color: Colors.grey[300])),
                                    ],
                                  ),
                                ),
                              ],
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Container(width: 10, height: 10, decoration: BoxDecoration(shape: BoxShape.circle, color: Colors.grey[300])),
                              ],
                            ),
                            ...
                            Shimmer(
                              child: Row(
                                children: [
                                  Container(width: 60, height: 14, decoration: BoxDecoration(color: Colors.grey[300], borderRadius: BorderRadius.circular(Dimensions.radiusSmall))),
                ...
                // Floating Add Button Shimmer (Bottom Right)
                Positioned(
                  bottom: 12,
                  right: 12,
                  child: Shimmer(
