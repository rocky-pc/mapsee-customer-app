      ...
      body: GetBuilder<ProfileController>(builder: (profileController) {
        return GetBuilder<SplashController>(builder: (splashController) {
          ...
          return Column(children: [
            SizedBox(
              height: isLoggedIn ? 160 : 220,
              child: Stack(
                children: [
                  Container(
                    width: double.infinity,
                    height: isLoggedIn ? 180 : 220,
                      ...
                      child: Column(children: [
                        Row(children: [
                          ...
                          Expanded(
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              isLoggedIn && profileController.userInfoModel != null ? Row(
                                children: [
                                  Text(
                                    '${'joined'.tr} ',
                        ...
                        !isLoggedIn ? Padding(
                          ...
                          child: Row(children: [
                            ...
                            // Expanded(child: Text('login_to_continue'.tr, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).cardColor.withOpacity(0.9)))),
                            // const SizedBox(width: Dimensions.paddingSizeDefault),
